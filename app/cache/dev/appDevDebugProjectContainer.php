...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.user.provider' => 'getApp_User_ProviderService',
        ...
        $this->aliases = array(
            ...
            'hwi_oauth.user.provider.entity.secured_area' => 'app.user.provider',
    ...
    /**
     * Gets the 'app.user.provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getApp_User_ProviderService()
    {
        return $this->services['app.user.provider'] = new \AppBundle\Security\UserProvider($this->get('doctrine'), 'AppBundle\\Entity\\UserGoogle', array('google' => 'googleId'), 'default');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('project_image', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('project_image', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('project_image', $e, $a, $b));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b0c64ac324faf8f83074c9cd69e63095fa38f760025ec8e4909544a36e5b8152');
    ...
    {
        return $this->services['hwi_oauth.resource_owner.google'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\GoogleResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '189346095685-fm5job04opont1336b4adbqggruct5mb.apps.googleusercontent.com', 'client_secret' => 'psxX8fjXS-7idk74k_BZKtQM', 'scope' => 'https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email', 'paths' => array('email' => 'email', 'profilepicture' => 'picture'), 'options' => array()), 'google', new \HWI\Bundle\OAuthBundle\OAuth\RequestDataStorage\SessionStorage($this->get('session')));
    }

    /**
     * Gets the 'hwi_oauth.resource_ownermap.secured_area' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        $this->services['hwi_oauth.resource_ownermap.secured_area'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array(0 => 'google'), array('google' => '/login/check-google'));
    ...
    protected function getHwiOauth_Security_OauthUtilsService()
    {
        ...
        $instance->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.secured_area'));
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.secured_area' => NULL, 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.default' => NULL)), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        return $this->services['security.firewall.map.context.default'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('app.user.provider')), 'default', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $c, 'default', $d, $b), 3 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5603f7b1d0ee84.67361510', $b, $c), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'default', $d, NULL, NULL, $b, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $i->setOptions(array('login_path' => '/login', 'failure_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $j = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($a, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $h, $i, array('use_forward' => false, 'check_path' => '/login_check', 'require_previous_session' => true), $b, $c);
        $j->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.secured_area'));
        $j->setCheckPaths(array(0 => '/login/check-google'));

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('app.user.provider')), 'secured_area', $b, $c), 2 => $g, 3 => $j, 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '5603f7b1d0ee84.67361510', $b, $f), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($e, $d, '/login', false), NULL, NULL, $b, false));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('50173c31e4412c72a3c58a7e1e57662bb03f14de');
    }
    ...
    {
        $a = $this->get('app.user.provider');
        $b = $this->get('hwi_oauth.user_checker');

        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($a, $this->get('hwi_oauth.resource_ownermap.secured_area'), $b), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5603f7b1d0ee84.67361510'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'default', $this->get('security.encoder_factory'), true), 3 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5603f7b1d0ee84.67361510')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '50173c31e4412c72a3c58a7e1e57662bb03f14de',
            'locale' => 'en',
            ...
            'kernel.secret' => '50173c31e4412c72a3c58a7e1e57662bb03f14de',
            ...
            'hwi_oauth.resource_ownermap.configured.secured_area' => array(
            ...
            'vich_uploader.mappings' => array(
                'project_image' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[2].'/../web/images/projects'),
